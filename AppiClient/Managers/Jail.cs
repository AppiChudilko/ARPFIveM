...
namespace Client.Managers
{
    public class Jail : BaseScript
    {
                ...
                if (User.Data.jail_time > 1)
                {
                    ...
                    else
                    {
                        ...
                        if (Main.GetDistanceToSquared(coords, JailCenter) > 200f && Main.GetDistanceToSquared(coords, CareerPos) > 100f)
                        {
                            ...
                            if (Warrning > 5)
                            {
                                JailPlayer(User.Data.jail_time + 30);
                                Notification.SendWithTime("~r~Попытка сбежать. +30 сек тюрьмы");
                            }
                        }
                    }
                }
        ...
        public static void JailPlayer(int sec)
        {
            ...
            JailPlayerWithoutTeleport(sec);
            Debug.WriteLine("JailPlayer work normally");
        }
        ...
        public static async void TeleportToJail(int sec)
        {
            ...
            if (sec < 1200)
            {
                ...
                User.Teleport(JailCop, 1000);
                //SetEntityCoords(playerPed, JailCenter.X, JailCenter.Y, JailCenter.Z, true, false, false, true);
            }
            else
            {
               
                User.Teleport(JailCenter, 1000);
                //SetEntityCoords(playerPed, JailCenter.X, JailCenter.Y, JailCenter.Z, true, false, false, true);
            }
        }

    ...
    public class Lang : BaseScript
    {
        ...
        public static string GetRuText(string key)
        {
            switch (key)
            {
                ...
                case "_lang_133":
                    return "У вас отсутствует лицензия на управление водным транспортом";
                case "_lang_134":
                    return "У вас отсутствует лицензия на управление вертолетом";
                case "_lang_135":
                    return "У вас отсутствует лицензия частного пилота";
                /*case "_lang_":
                    return "";
                case "_lang_":
                    return "";

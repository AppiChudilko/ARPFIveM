...
{
    public class WaterPower : BaseScript
    {
        ...
        public static void FindHouse()
        {
            ...
            Managers.Checkpoint.CreateWithMarker(pos, 1.1f, 1.1f, Marker.Red.R, Marker.Red.G, Marker.Red.B, Marker.Red.A, "job:waterpower:work");
            User.SetWaypoint(pos.X, pos.Y);
        }

        public static void TakeTool()
        {
            if (Sync.Data.HasLocally(User.GetServerId(), "WaterPowerTool"))
            {
            ...
            Sync.Data.SetLocally(User.GetServerId(), "WaterPowerTool", true);
        }
        ...
        public static async void WorkProcess()
        {
            ...
            await Delay(30000);
            Sync.Data.ResetLocally(User.GetServerId(), "WaterPowerTool");
            IsProcess = false;

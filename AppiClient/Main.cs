...
namespace Client
{
  ...
  {"Высокорменая","move_f@arrogant@a"},
  {"Нахальная","move_m@brave"},
  {"Спокойная","move_m@casual@a"},
  {"Задумчивая","move_m@casual@b"},
  {"Настороженная","move_m@casual@c"},
  {"Медленная","move_m@casual@d"},
  {"Хипстерская","move_m@casual@e"},
  {"Модельная","move_f@chichi"},
  {"Коп","move_m@business@a"},
  {"Коп2","move_m@business@b"},
  {"Женская","move_f@multiplayer"},
  
  {"Пьяный","move_m@drunk@a"},
  {"Пьяный2","move_m@drunk@slightlydrunk"},
  {"Пьяный3","move_m@buzzed"},
  {"Пьяный4","move_m@drunk@verydrunk"},
  {"С сумочкой","move_f@femme@"},
  {"Устрашающая","move_characters@franklin@fire"},
  {"Устрашающая2","move_characters@michael@fire"},
  {"Устрашающая3","move_m@fire"},
  {"Провинившийся","move_m@gangster@var_f"},
  {"В наушниках","anim@move_m@grooving@"},
  {"Охрана","move_m@prison_gaurd"},
  {"В наручниках","move_m@prisoner_cuffed"},
  {"Туристическая","move_m@hiking"},
  {"Напуганный","move_f@hurry@a"},
  {"Шальная","move_f@maneater"},
  {"Уверенный","move_m@muscle@a"},
  {"Трусцой","move_m@quick"}
        };
        
        public static string[,] ClipsetFemale =
        {
            {"Стандартная","move_m@multiplayer"},
            { "Уставшая", "ANIM_GROUP_MOVE_LEMAR_ALLEY" }, 
  { "С кулаком", "clipset@move@trash_fast_turn" }, 
  { "С предметом в руке", "missfbi4prepp1_garbageman" }, 
  { "С бодуна", "move_characters@franklin@fire" }, 
  ...
  {"Трусцой","move_m@quick"}
        ...
        public static string[,] ClipsetFemale2 =
        {
            {"Стандартная","move_m@multiplayer"},
            {"Уставшая", "ANIM_GROUP_MOVE_LEMAR_ALLEY" }, 
            {"Дамская", "FEMALE_FAST_RUNNER" }, 
        ...
        public static string[,] ClipsetMale2 =
        {
            {"Стандартная","move_m@multiplayer"},
            {"Уставшая", "ANIM_GROUP_MOVE_LEMAR_ALLEY" }, 
            {"Дамская", "FEMALE_FAST_RUNNER" }, 

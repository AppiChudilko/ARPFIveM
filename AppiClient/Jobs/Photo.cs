...
namespace Client.Jobs
{
    public class Photo : BaseScript
    {
        ...
        public static async void WorkProcess()
        {
            ...
            User.GiveJobMoney(50 + rand.Next(50));
            Stop();
        }
        ...
        public static void Stop()
        {
            ...
            Managers.Checkpoint.DeleteWithMarker("job:photo:work");
        }
        ...
        public static void FindRandomPickup()
        {
            ...
            int pickupId = rand.Next(0, 145);
            var pickupPos = new Vector3((float) Pickups[pickupId, 0], (float) Pickups[pickupId, 1], (float) Pickups[pickupId, 2] - 1f);
            Managers.Checkpoint.CreateWithMarker(pickupPos, 1f, 1f, Marker.Red.R, Marker.Red.G, Marker.Red.B, Marker.Red.A, "job:photo:work");
